    ...
    <div className="min-h-screen">
      <header className="sticky top-0 z-30 border-b border-black/5 bg-[#f8f6f1]/90 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-4 sm:flex-nowrap sm:px-6">
          ...
          <div className="order-3 flex w-full min-w-28 flex-col items-end gap-2 sm:order-none sm:w-auto">
            {USE_MOCK_API ? (
            ...
            {!USE_MOCK_API && (
              <a href="/slack/link" className="text-xs font-semibold text-stone-500 underline-offset-4 hover:text-ink hover:underline">
                내 Slack 기록
              </a>
            )}
          </div>
