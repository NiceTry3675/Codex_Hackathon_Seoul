    ...
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-16">
      ...
      {!room ? (
        ...
        <form onSubmit={submitForm} className="mt-8 space-y-6">
          {room.submission_mode === "anonymous" && (
            <p className="text-sm leading-6 text-stone-500">
              팀원에게는 제출자 이름과 개인별 평가를 공개하지 않습니다.
              {!USE_MOCK_API && " Slack 또는 Slack과 연결한 Google 계정으로 제출하면, 중복 제출 방지와 내 기록을 위해 제출 여부를 계정에 연결해 저장합니다."}
            </p>
          )}
